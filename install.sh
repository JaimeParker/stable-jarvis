...
CODING_SKILLS=("continuous-agent-loop" "continuous-learning" "continuous-learning-v2" "cpp-coding-standards" "docker-patterns" "iterative-retrieval" "markdown-to-html" "premium-frontend-ui" "python-patterns" "verification-loop" "videodb" "web-coder" "writing-plans")
